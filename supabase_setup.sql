...
-- Go to: https://supabase.com/dashboard/project/cxmvoykanctcoyjzcinv/sql/new

-- 1. Countries table (master list)
...
-- 3. Favorites table (by browser fingerprint for simplicity)
